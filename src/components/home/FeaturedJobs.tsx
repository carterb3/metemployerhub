...
import { MapPin, Clock, ArrowRight, Briefcase, DollarSign } from "lucide-react";
...
function FeaturedJobCard({ job }: FeaturedJobCardProps) {
  ...
  return (
    <Link
      to={`/jobs/${job.id}`}
      className="group block bg-card rounded-xl border border-border p-5 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary/30"
    >
      <div className="flex items-start justify-between gap-4 mb-3">
...
export function FeaturedJobs() {
  ...
  // Get the 6 most recent active jobs
